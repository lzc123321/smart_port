...
//
//    // 配置数据库信息pet_manager
//    private static final String URL = "jdbc:mysql://localhost:3306/smartairport?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
//    private static final String USERNAME = "root";
//    private static final String PASSWORD = "535489";
//    // 项目根目录
//    private static final String PROJECT_ROOT_PATH = System.getProperty("user.dir");
//    private static final String BASE_PATH = PROJECT_ROOT_PATH + "/src/main/java/com/example/spring1";
//    private static final String PARENT_PACKAGE_NAME = "com.example.spring1";
//
//    // 执行main方法
